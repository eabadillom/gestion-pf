...
public class ClienteContactoDAO extends BaseDAO<ClienteContacto, Integer> {
    ...
    public List<ClienteContacto> obtenerPorClienteId(Cliente cliente) throws DAOException {
        ...
        try {
            ...
            log.error("Error al obtener los contactos del cliente cliente: " + cliente.getNombre(), ex);
            throw new DAOException("No se obtuvieron los contactos del cliente " + cliente.getNombre(), ex);
        } finally {
            super.close(em);
        }
