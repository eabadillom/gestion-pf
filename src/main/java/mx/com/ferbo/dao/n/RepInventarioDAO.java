...
public class RepInventarioDAO extends BaseDAO<RepInventario, Integer> 
{
    ...
    public List<RepInventario> buscar(Date fecha, List<Integer> listClientes, Integer idPlanta, Integer idCamara) 
    {
        ...
        try {
            sql = "select * from ( "
                    ...
                    + "		WHERE (:idCliente IS NULL OR cdd.cte_cve IN :idCliente) "
