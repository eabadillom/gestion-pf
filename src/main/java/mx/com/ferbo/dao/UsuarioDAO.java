...
public class UsuarioDAO extends IBaseDAO<Usuario, Integer> {
	...
	public Usuario buscarPorUsuario(String username) {
		...
		try {
			em = EntityManagerUtil.getEntityManager();
			usuario = em.createNamedQuery("Usuario.findByUsuario", Usuario.class).setParameter("usuario", username)
					.getSingleResult();
		} catch (Exception ex) {
	...
	public List<Usuario> buscarPorPerfil(Integer idPerfil) {
		...
		try {
			em = EntityManagerUtil.getEntityManager();
			usuarios = em.createNamedQuery("Usuario.findByPerfil", Usuario.class).setParameter("perfil", idPerfil)
					.getResultList();
		} catch (Exception ex) {
