...
public class SerieNotaDAO {
	 ...
	 * 
	 * @param idPlanta Por el momento, el parámetro idPlanta no se ocupa, pero se
	 *                 prepara para que a futuro se utilice con el timbrado CFDI.
	...
	public List<SerieNota> buscarActivas(Integer idPlanta) {
		...
		try {
			entity = EntityManagerUtil.getEntityManager();
			lista = entity.createNamedQuery("SerieNota.findActivas", SerieNota.class).getResultList();
