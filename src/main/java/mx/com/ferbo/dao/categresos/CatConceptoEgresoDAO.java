...
@Named
@ApplicationScoped
public class CatConceptoEgresoDAO extends CatEgresoBaseDAO<CatConceptoEgreso> {
    ...
    @Override
    protected Class<CatConceptoEgreso> getEntityClass() {
        return CatConceptoEgreso.class;
    }
}
