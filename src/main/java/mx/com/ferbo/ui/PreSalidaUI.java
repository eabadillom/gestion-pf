...
public class PreSalidaUI extends OrdenDeSalidas {
	...
	public PreSalidaUI(String folioSalida, String status, Date fechaSalida, Time horaSalida, Integer partidaCve,
		...
		super(folioSalida, status, fechaSalida, horaSalida, partidaCve, cantidad, peso, codigo, lote, fechaCaducidad,
				sap, pedimento, temperatura, unidadManejo, codigoProducto, nombreProducto, nombrePlanta, nombreCamara,
				folioOrdenSalida, productoCve, unidadManejoCve);
