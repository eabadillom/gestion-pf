package mx.com.ferbo.modulos.empresa.model;
...
public class EmisorCFDI implements Serializable, Empresa {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof EmisorCFDI))
            return false;

        EmisorCFDI that = (EmisorCFDI) o;
