...
public class JasperReportUtil {
    ...
    public byte[] createPDF(Map<String, Object> jrParams, String jrxmlPath) throws IOException {
        ...
        try {
            ...
            /*if (jrParams.containsKey("REPORT_CONNECTION") && jrParams.get("REPORT_CONNECTION") instanceof Connection) {
                Connection conn = (Connection) jrParams.get("REPORT_CONNECTION");
                jasperPrint = JasperFillManager.fillReport(report, jrParams, conn);
            } else {
                jasperPrint = JasperFillManager.fillReport(report, jrParams, new JREmptyDataSource());
            }*/
