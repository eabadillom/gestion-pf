...
public class DateUtil {
	...
	// (o región geográfica, según la tabla IPITOOLS_HOLYDAYS O
	// BMEA_IPITOOLS_HOLYDAYS
	...
	public static String getMes(int mes)
		...
		switch (mes) {
			...
			case DICIEMBRE:
				...
				break;
			default:
				throw new InventarioException("El mes no es válido: " + mes);
		}
		return strMes;
	}
	 ...
	 *              {@link Date}.
	 *              Vea las constantes de la clase {@link DateUtils} para establecer
	...
	public static String getString(Date fecha, String formato)
		...
		dateFormat = new SimpleDateFormat(formato);
		if (fecha == null)
			throw new InventarioException("El parámetro fecha no debe ser nulo");
	...
	public static boolean esAnioBisiesto(Date fecha) {
		...
		cal.setTime(fecha);
		anioBisiesto = cal.isLeapYear(getAnio(fecha));
