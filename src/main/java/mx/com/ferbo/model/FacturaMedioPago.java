...
@NamedQueries({ @NamedQuery(name = "FacturaMedioPago.findAll", query = "SELECT f FROM FacturaMedioPago f"),
...
public class FacturaMedioPago implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.facturaMedioPagoPK == null && other.facturaMedioPagoPK != null)
				|| (this.facturaMedioPagoPK != null && !this.facturaMedioPagoPK.equals(other.facturaMedioPagoPK))) {
			return false;
		}
		return true;
	}
