...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "PrecioServicio.findAll", query = "SELECT p FROM PrecioServicio p"),
...
public class PrecioServicio implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if (this.avisoCve != other.avisoCve || this.getCliente().getCteCve() != other.getCliente().getCteCve()
				|| this.getServicio().getServicioCve() != other.getServicio().getServicioCve())
			return false;
