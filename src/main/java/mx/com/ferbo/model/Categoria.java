...
@NamedQueries({ @NamedQuery(name = "Categoria.findAll", query = "SELECT c FROM Categoria c ORDER BY c.categoriaDs"),
...
public class Categoria implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.categoriaCve == null && other.categoriaCve != null)
				|| (this.categoriaCve != null && !this.categoriaCve.equals(other.categoriaCve))) {
			return false;
		}
		return true;
	}
