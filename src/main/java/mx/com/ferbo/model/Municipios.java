...
@NamedQueries({ @NamedQuery(name = "Municipios.findAll", query = "SELECT m FROM Municipios m"),
		...
		// @NamedQuery(name = "Municipios.findByMunicipioDs", query = "SELECT m FROM
		// Municipios m WHERE m.municipioDs = :municipioDs"),
...
public class Municipios implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.municipiosPK == null && other.municipiosPK != null)
				|| (this.municipiosPK != null && !this.municipiosPK.equals(other.municipiosPK))) {
			return false;
		}
		return true;
	}
