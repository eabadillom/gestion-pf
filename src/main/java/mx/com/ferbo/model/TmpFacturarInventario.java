...
@NamedQueries({ @NamedQuery(name = "TmpFacturarInventario.findAll", query = "SELECT t FROM TmpFacturarInventario t"),
...
public class TmpFacturarInventario implements Serializable {
	...
	public TmpFacturarInventario(TmpFacturarInventarioPK tmpFacturarInventarioPK, int folio, String folioCliente,
			Date fechaDeposito, Date servicioInicio, Date servicioFin, int servicioDias, int servicioCve,
			String servicio, BigDecimal cantidadSer, BigDecimal cuota, BigDecimal cuotaDiaria, String producto,
			BigDecimal peso, String unidad, BigDecimal cantidad, String unidadCobro, BigDecimal importe, BigDecimal iva,
			BigDecimal total, BigDecimal noTarimas) {
		this.tmpFacturarInventarioPK = tmpFacturarInventarioPK;
		this.folio = folio;
	...
	public boolean equals(Object object) {
		...
		if ((this.tmpFacturarInventarioPK == null && other.tmpFacturarInventarioPK != null)
				|| (this.tmpFacturarInventarioPK != null
						&& !this.tmpFacturarInventarioPK.equals(other.tmpFacturarInventarioPK))) {
			return false;
		}
		return true;
	}
