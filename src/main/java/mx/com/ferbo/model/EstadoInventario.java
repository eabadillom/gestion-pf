...
@NamedQueries({ @NamedQuery(name = "EstadoInventario.findAll", query = "SELECT e FROM EstadoInventario e"),
...
public class EstadoInventario implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.edoInvCve == null && other.edoInvCve != null)
				|| (this.edoInvCve != null && !this.edoInvCve.equals(other.edoInvCve))) {
			return false;
		}
		return true;
	}
