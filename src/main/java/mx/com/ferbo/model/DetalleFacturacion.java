...
@NamedQueries({ @NamedQuery(name = "DetalleFacturacion.findAll", query = "SELECT d FROM DetalleFacturacion d"),
...
public class DetalleFacturacion implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.detalleFacturacionPK == null && other.detalleFacturacionPK != null)
				|| (this.detalleFacturacionPK != null
						&& !this.detalleFacturacionPK.equals(other.detalleFacturacionPK))) {
			return false;
		}
		return true;
	}
