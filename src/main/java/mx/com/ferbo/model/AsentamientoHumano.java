...
@NamedQueries({ @NamedQuery(name = "AsentamientoHumano.findAll", query = "SELECT a FROM AsentamientoHumano a"),
...
public class AsentamientoHumano implements Serializable {
	...
	public AsentamientoHumano(int paisCve, int estadoCve, int municipioCve, int ciudadCve, short tipoasntmntoCve,
			int entidadpostalCve, int asentamientoCve) {
		this.asentamientoHumanoPK = new AsentamientoHumanoPK(paisCve, estadoCve, municipioCve, ciudadCve,
				tipoasntmntoCve, entidadpostalCve, asentamientoCve);
	}
	...
	public boolean equals(Object object) {
		...
		if ((this.asentamientoHumanoPK == null && other.asentamientoHumanoPK != null)
				|| (this.asentamientoHumanoPK != null
						&& !this.asentamientoHumanoPK.equals(other.asentamientoHumanoPK))) {
			return false;
		}
		return true;
	}
