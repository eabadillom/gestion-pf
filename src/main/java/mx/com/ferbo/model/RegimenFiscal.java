...
public class RegimenFiscal implements Serializable {
	...
	private EmisoresCFDIS cd_regimen;
	...
	public EmisoresCFDIS getCd_regimen() {
		return cd_regimen;
	}

	public void setCd_regimen(EmisoresCFDIS cd_regimen) {
	...
	public RegimenFiscal(@NotNull @Size(min = 1, max = 15) EmisoresCFDIS cd_regimen,
