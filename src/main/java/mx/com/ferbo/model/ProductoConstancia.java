...
@NamedQueries({ @NamedQuery(name = "ProductoConstancia.findAll", query = "SELECT p FROM ProductoConstancia p"),
...
public class ProductoConstancia implements Serializable {
	...
	public ProductoConstancia(Integer id, String descripcion, int constancia, BigDecimal catidadCobro,
			String unidadCobro) {
		this.id = id;
