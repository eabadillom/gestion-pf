...
public class AsentamientoHumanoPK implements Serializable {
	...
	public AsentamientoHumanoPK(int paisCve, int estadoCve, int municipioCve, int ciudadCve, short tipoasntmntoCve,
	...
	public String toString() {
		return "mx.com.ferbo.model.AsentamientoHumanoPK[ paisCve=" + paisCve + ", estadoCve=" + estadoCve
				+ ", municipioCve=" + municipioCve + ", ciudadCve=" + ciudadCve + ", tipoasntmntoCve=" + tipoasntmntoCve
				+ ", entidadpostalCve=" + entidadpostalCve + ", asentamientoCve=" + asentamientoCve + " ]";
	}
