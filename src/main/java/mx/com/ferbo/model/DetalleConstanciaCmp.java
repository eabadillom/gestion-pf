...
@NamedQueries({ @NamedQuery(name = "DetalleConstanciaCmp.findAll", query = "SELECT d FROM DetalleConstanciaCmp d"),
...
public class DetalleConstanciaCmp implements Serializable {
	...
	public DetalleConstanciaCmp(Integer id, int servicioCve, String servicioDs, BigDecimal cantidadSer,
			BigDecimal cuota, BigDecimal cuotaDiaria, int dias, int productoCve, String productoDs, BigDecimal peso,
			String unidadPeso, BigDecimal cantidad, String unidadManejo, BigDecimal valor, BigDecimal importe,
			BigDecimal iva, BigDecimal total, int partidaCve, int plantaCve, String plantaDs, String plantaAbrev,
