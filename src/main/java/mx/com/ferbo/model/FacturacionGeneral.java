...
public class FacturacionGeneral implements Comparable<Object> {
	...
	public String toString() {
		return "FacturacionGeneral [total_facturacion=" + total_facturacion + ", fecha=" + fecha + ", acumulado="
				+ acumulado + ", porcentaje=" + porcentaje + ", total_por_efectivo=" + total_por_efectivo + "]";
	}
