...
@NamedQueries({ @NamedQuery(name = "DetallePartida.findAll", query = "SELECT d FROM DetallePartida d"),
...
//    private DetalleConstanciaSalida detalleConstanciaSalida;
	...
	@JoinColumns({ @JoinColumn(name = "det_anterior", referencedColumnName = "DET_PART_CVE"),
...
//    }
	...
	public boolean equals(Object object) {
		...
		if ((this.detallePartidaPK == null && other.detallePartidaPK != null)
				|| (this.detallePartidaPK != null && !this.detallePartidaPK.equals(other.detallePartidaPK))) {
			return false;
		}
		return true;
	}
