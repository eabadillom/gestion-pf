...
public class ConstanciaDepositoDetalle implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.constanciaDepositoDetalleCve == null && other.constanciaDepositoDetalleCve != null)
				|| (this.constanciaDepositoDetalleCve != null
						&& !this.constanciaDepositoDetalleCve.equals(other.constanciaDepositoDetalleCve))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "mx.com.ferbo.model.ConstanciaDepositoDetalle[ constanciaDepositoDetalleCve="
				+ constanciaDepositoDetalleCve + " ]";
	}
