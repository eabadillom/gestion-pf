...
//		}
    ...
    public void loadAviso() {
        try {
            ...
            Integer avisoId = Optional.ofNullable(aviso)
                          .map(Aviso::getAvisoCve)
                          .orElse(-1);

            PrecioServicio psCongelacion = precioServicioDAO.buscar(this.clienteSelect.getCteCve(), avisoId, this.congelacion, true);
            PrecioServicio psConservacion = precioServicioDAO.buscar(this.clienteSelect.getCteCve(), avisoId, this.conservacion, true);
            PrecioServicio psRefrigeracion = precioServicioDAO.buscar(this.clienteSelect.getCteCve(), avisoId, this.refrigeracion, true);
            PrecioServicio psManiobras = precioServicioDAO.buscar(this.clienteSelect.getCteCve(), avisoId, this.maniobras, true);
