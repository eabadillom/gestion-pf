...
@Named
@ViewScoped
public class ReporteCobranzaBean implements Serializable {

	private static final long serialVersionUID = 1L;
	private static Logger log = LogManager.getLogger(ReporteCobranzaBean.class);
	...
	public void exportarPdf() throws JRException, IOException, SQLException {
		...
		String jasperPath = "/jasper/reporteCobranza.jrxml";
		String filename = "reporteCobranza" + fecha + ".pdf";
	...
	public void exportarExcel() throws JRException, IOException, SQLException {
		...
		String jasperPath = "/jasper/reporteCobranza.jrxml";
		String filename = "reporteCobranza" + fecha + ".xlsx";
		String images = "/images/logo.jpeg";
		String message = null;
		Severity severity = null;
		File reportFile = new File(jasperPath);
