...
@Named
@ViewScoped
public class ClientesDomiciliosBean implements Serializable 
{
    private static final long serialVersionUID = 4150584435387992139L;
    private static Logger log = LogManager.getLogger(ClientesDomiciliosBean.class);
    ...
    */
    ...
    public void guardarCliente(){
        ...
        try{
            ...
            mensaje = "Actualizando domicilios del cliente";
            severity = FacesMessage.SEVERITY_INFO;
        } catch (InventarioException ex) {
