...
import mx.com.ferbo.dao.n.RepEntradasDAO;
...
public class ReporteEntradasBean implements Serializable 
{
    ...
    @Inject
    private RepEntradasDAO reporteDAO;
    ...
    private ReporteEntradasJR reporteEntradaJR = null;
    private StreamedContent file;

    private List<RepEntradas> reporte = null;
    ...
    public void init() {
        ...
        fechaIni = new Date();
        fechaFin = new Date();
        log.info("El usuario {} esta ingresando a reporte de entradas", usuario.getUsuario());
    }
    ...
    public void exportarPdf() throws JRException, IOException, SQLException {
        ...
        try {
            ...
            reporteEntradaJR = new ReporteEntradasJR(connection, images);
            byte[] bytes = reporteEntradaJR.getPDF(fechaIni, fechaFin, listClientes, plantaCve, camaraCve);
            InputStream input = new ByteArrayInputStream(bytes);
            this.file = DefaultStreamedContent.builder().contentType("application/pdf").name(filename)
                    .stream(() -> input).build();
            log.info("El usuario {} descargo el reporte de entradas {}", this.usuario.getUsuario(), filename);
        } catch (Exception ex) {
    ...
    public void exportarExcel() throws JRException, IOException, SQLException {
        ...
        try {
            ...
            connection = EntityManagerUtil.getConnection();
            reporteEntradaJR = new ReporteEntradasJR(connection, images);
            byte[] bytes = reporteEntradaJR.getXLSX(fechaIni, fechaFin, listClientes, plantaCve, camaraCve);
            InputStream input = new ByteArrayInputStream(bytes);
    ...
    public void generaReporte() {
        ...
        Severity severity = null;
        String mensaje = null;
        String titulo = "Reporte de Entradas";
