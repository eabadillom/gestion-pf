...
@Named
@ViewScoped
public class ReporteClienteEstadoCuentaBean implements Serializable {

	private static final long serialVersionUID = 1L;
	private static Logger log = LogManager.getLogger(ReporteClienteEstadoCuentaBean.class);
	...
	public void exportarPdf() throws JRException, IOException, SQLException {
		...
		String jasperPath = "/jasper/reporteEstadoCuentaCliente.jrxml";
		String filename = "reporteEstadoCuentaCliente" + fecha + ".pdf";
		...
		try {
			...
			PrimeFaces.current().ajax().update("form:messages", "form:dt-ClienteEstadoCuenta");
		} finally {
	...
	public void exportarExcel() throws JRException, IOException, SQLException {
		...
		String jasperPath = "/jasper/reporteEstadoCuentaCliente.jrxml";
		String filename = "reporteEstadoCuentaCliente" + fecha + ".xlsx";
		String images = "/images/logo.jpeg";
		String message = null;
		Severity severity = null;
		File reportFile = new File(jasperPath);
