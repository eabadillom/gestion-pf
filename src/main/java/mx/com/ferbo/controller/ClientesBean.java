...
public class ClientesBean implements Serializable {
    ...
    public void nuevoContacto(Cliente clienteSel) {
        clienteContactoSelected = ContactoBL.nuevoContacto(this.clienteSelected.getClienteContactoList());
    ...
    public void guardarCliente() {
        ...
        try {
            ...
            ClienteBL.validarCodigoUnico(clienteSelected);
    ...
    public void validarRFC() {
        ...
        try {
            ClienteBL.validarRFC(this.clienteSelected);
    ...
    public void validateNewPassword() {
        ...
        try {
            ContactoBL.validateNewPassword(this.newPassword, this.confirmPassword);
    ...
    public void changePassword() {
        ...
        try {
            this.clienteContactoSelected = ContactoBL.changePassword(this.clienteContactoSelected, this.newPassword, this.confirmPassword);
