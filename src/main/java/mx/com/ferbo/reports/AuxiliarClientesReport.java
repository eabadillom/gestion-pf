...
public class AuxiliarClientesReport extends ReportBL {
	
	private static Logger log = LogManager.getLogger(AuxiliarClientesReport.class);
	
	private static final String LOGO_PATH  = "/images/logoF.png";
	private static final String JRXML_PATH = "/jasper/reportAuxCtes.jrxml";
	...
	public static synchronized byte[] getPDF(Date periodoInicio, Date periodoFin, Integer idCliente) {
		...
		try {
			...
			log.info("parametros del reporte: {}", parameters);
